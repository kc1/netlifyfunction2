...
exports.handler = async (event, context) => {
  ...
  const waterText =
    "in the role of a real estate investor and land surveyor, can you estimate how much pf the selected lot is covered by water or in a flood zone?. In the response, please return the following: the full reasoning text ,followed by 2 empty newlines, followed by string ----------- , followed by 2 newlines, followed by a json template that looks like: {estimated percentage flood zone: <>, estimated percentage ground water: <>, and total estimated percentage: <>}";
