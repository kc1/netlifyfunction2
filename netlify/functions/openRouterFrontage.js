...
exports.handler = async (event, context) => {
  ...
  const createAnalysisPrompt = (xFeet) => `
  ...
  Given that the total length of the boundary line is ${xFeet} feet, examine whether there is a road lying within or adjacent to the lot.
  ...
  {
    "Estimated Road Length in feet": <integer only>,
    "Orientation of the major portion of the road that is adjacent to or within the lot": "<NORTH|SOUTH|EAST|WEST>"
  }
